...
public class ConfigManager {
     ...
     */
    public FileHolder getNewConfig(String filePath, String[] header) {
        ...
        FileHolder config = new FileHolder(this.getConfigContent(filePath),
     ...
     * @return - New SimpleConfig
     */
    public FileHolder getNewConfig(String filePath) {
